...
/**
 * A derived attribute representing the amount of weight that can be carried. Differs from the other
...
public class CarryAttribute implements Attribute, PropertyChangeListener {
   ...
   * @param parentAttribute the attribute used to derive the weight that a person can carry
   */
