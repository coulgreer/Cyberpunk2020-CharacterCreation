...
public final class SkillManager implements StatisticManager<CyberpunkSkill> {
	...
	private TreeNode<CyberpunkSkill> allSkills;
	private TreeNode<CyberpunkSkill> roleSkills;
	private TreeNode<CyberpunkSkill> attractivenessSkills;
	private TreeNode<CyberpunkSkill> bodyTypeSkills;
	private TreeNode<CyberpunkSkill> coolSkills;
	private TreeNode<CyberpunkSkill> empathySkills;
	private TreeNode<CyberpunkSkill> intelligenceSkills;
	private TreeNode<CyberpunkSkill> knowLanguage;
	private TreeNode<CyberpunkSkill> nigerCongoFamily;
	private TreeNode<CyberpunkSkill> finnicFamily;
	private TreeNode<CyberpunkSkill> balticFamily;
	private TreeNode<CyberpunkSkill> celticFamily;
	private TreeNode<CyberpunkSkill> germanicFamily;
	private TreeNode<CyberpunkSkill> pacificIslandGroupFamily;
	private TreeNode<CyberpunkSkill> romanticFamily;
	private TreeNode<CyberpunkSkill> semeticFamily;
	private TreeNode<CyberpunkSkill> sinoTibetanAndSouthEastAsianFamily;
	private TreeNode<CyberpunkSkill> slavicFamily;
	private TreeNode<CyberpunkSkill> reflexSkills;
	private TreeNode<CyberpunkSkill> martialArt;
	private TreeNode<CyberpunkSkill> piloting;
	...
	public SkillManager(StatisticManager<Attribute> attributeManager, Player player) {
		...
		initializeDependantSkills(); // This should be last as to make sure all skills are properly initiated.
	}

	private void initializeRoleSkills(Player player) {
		roleSkills = new TreeNode<CyberpunkSkill>(CyberpunkSkill.SPECIAL_SKILLS, null);
		allSkills.appendChild(roleSkills);
		roleSkills.appendChild(CyberpunkSkill.AUTHORITY, new RoleSkill(cool, CyberpunkSkill.AUTHORITY,
	...
	private void initializeAttractivenessSkills() {
		...
		attractivenessSkills = new TreeNode<CyberpunkSkill>(CyberpunkSkill.ATTRACTIVENESS_SKILLS, null);
		allSkills.appendChild(attractivenessSkills);
		attractivenessSkills.appendChild(CyberpunkSkill.PERSONAL_GROOMING, new SpecializedSkill(attribute,
				...
				1));
		attractivenessSkills.appendChild(CyberpunkSkill.WARDROBE_AND_STYLE, new SpecializedSkill(attribute,
	...
	private void initializeBodyTypeSkills() {
		...
		bodyTypeSkills = new TreeNode<CyberpunkSkill>(CyberpunkSkill.BODY_TYPE_SKILLS, null);
		allSkills.appendChild(bodyTypeSkills);
		bodyTypeSkills.appendChild(CyberpunkSkill.ENDURANCE, new SpecializedSkill(attribute, CyberpunkSkill.ENDURANCE,
				...
				1));
		bodyTypeSkills.appendChild(CyberpunkSkill.STRENGTH_FEAT, new SpecializedSkill(attribute,
				...
				1));
		bodyTypeSkills.appendChild(CyberpunkSkill.SWIMMING, new SpecializedSkill(attribute, CyberpunkSkill.SWIMMING,
	...
	private void initializeCoolSkills() {
		...
		coolSkills = new TreeNode<CyberpunkSkill>(CyberpunkSkill.COOL_SKILLS, null);
		allSkills.appendChild(coolSkills);
		coolSkills.appendChild(CyberpunkSkill.INTERROGATION, new SpecializedSkill(attribute,
				...
				1));
		coolSkills.appendChild(CyberpunkSkill.INTIMIDATE,
				new SpecializedSkill(attribute, CyberpunkSkill.INTIMIDATE,
						...
						1));
		coolSkills.appendChild(CyberpunkSkill.ORATORY, new SpecializedSkill(attribute, CyberpunkSkill.ORATORY,
				...
				1));
		coolSkills.appendChild(CyberpunkSkill.RESIST_TORTURE_AND_DRUGS, new SpecializedSkill(attribute,
				...
				1));
		coolSkills.appendChild(CyberpunkSkill.STREETWISE, new SpecializedSkill(attribute, CyberpunkSkill.STREETWISE,
	...
	private void initializeEmpathySkills() {
		...
		empathySkills = new TreeNode<CyberpunkSkill>(CyberpunkSkill.EMPATHY_SKILLS, null);
		allSkills.appendChild(empathySkills);
		empathySkills.appendChild(CyberpunkSkill.HUMAN_PERCEPTION, new SpecializedSkill(attribute,
				...
				1));
		empathySkills.appendChild(CyberpunkSkill.INTERVIEW, new SpecializedSkill(attribute, CyberpunkSkill.INTERVIEW,
				...
				1));
		empathySkills.appendChild(CyberpunkSkill.LEADERSHIP, new SpecializedSkill(attribute, CyberpunkSkill.LEADERSHIP,
				...
				1));
		empathySkills.appendChild(CyberpunkSkill.SEDUCTION, new SpecializedSkill(attribute, CyberpunkSkill.SEDUCTION,
				...
				1));
		empathySkills.appendChild(CyberpunkSkill.SOCIAL, new SpecializedSkill(attribute, CyberpunkSkill.SOCIAL,
				...
				1));
		empathySkills.appendChild(CyberpunkSkill.PERSUASION, new SpecializedSkill(attribute, CyberpunkSkill.PERSUASION,
				...
				1));
		empathySkills.appendChild(CyberpunkSkill.PERFORM,
				new SpecializedSkill(attribute, CyberpunkSkill.PERFORM, "The skill of trained acting, singing, etc." //
	...
	private void initializeIntelligenceSkills() {
		...
		intelligenceSkills = new TreeNode<CyberpunkSkill>(CyberpunkSkill.INTELLIGENCE_SKILLS, null);
		allSkills.appendChild(intelligenceSkills);
		intelligenceSkills.appendChild(CyberpunkSkill.ACCOUNTING, new SpecializedSkill(attribute,
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.ANTHROPOLOGY, new SpecializedSkill(attribute,
				CyberpunkSkill.ANTHROPOLOGY, "The knowledge of human cultures, habits and customs." //
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.AWARENESS, new SpecializedSkill(attribute,
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.BIOLOGY, new SpecializedSkill(attribute, CyberpunkSkill.BIOLOGY,
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.BOTANY, new SpecializedSkill(attribute, CyberpunkSkill.BOTANY,
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.CHEMISTRY,
				new SpecializedSkill(attribute, CyberpunkSkill.CHEMISTRY,
						...
						1));
		intelligenceSkills.appendChild(CyberpunkSkill.COMPOSITION, new SpecializedSkill(attribute,
				CyberpunkSkill.COMPOSITION, "The required skill for writing songs, articles, or stories." //
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.DIAGNOSE_ILLNESS, new SpecializedSkill(attribute,
				CyberpunkSkill.DIAGNOSE_ILLNESS, "The skill of clinically diagnosing symptoms and medical problems." //
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.EDUCATION, new SpecializedSkill(attribute,
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.EXPERT, new SpecializedSkill(attribute, CyberpunkSkill.EXPERT,
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.GAMBLE, new SpecializedSkill(attribute, CyberpunkSkill.GAMBLE,
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.GEOLOGY, new SpecializedSkill(attribute, CyberpunkSkill.GEOLOGY,
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.HIDE_AND_EVADE,
				new SpecializedSkill(attribute, CyberpunkSkill.HIDE_AND_EVADE,
						...
						1));
		intelligenceSkills.appendChild(CyberpunkSkill.HISTORY, new SpecializedSkill(attribute, CyberpunkSkill.HISTORY,
		...
		intelligenceSkills.appendChild(CyberpunkSkill.LIBRARY_SEARCH, new SpecializedSkill(attribute,
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.MATHEMATICS,
				new SpecializedSkill(attribute, CyberpunkSkill.MATHEMATICS,
						...
						1));
		intelligenceSkills.appendChild(CyberpunkSkill.PROGRAMMING, new SpecializedSkill(attribute,
				CyberpunkSkill.PROGRAMMING, "The required skill to write programs and to re-program computer systems." //
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.SHADOW_AND_TRACK, new SpecializedSkill(attribute,
				CyberpunkSkill.SHADOW_AND_TRACK, "The skill of shadowing and following people. " //
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.STOCK_MARKET, new SpecializedSkill(attribute,
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.SYSTEM_KNOWLEDGE, new SpecializedSkill(attribute,
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.TEACHING, new SpecializedSkill(attribute, CyberpunkSkill.TEACHING,
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.WILDERNESS_SURVIVAL, new SpecializedSkill(attribute,
				CyberpunkSkill.WILDERNESS_SURVIVAL, "The required skill for knowing how to survive in the wilds." //
				...
				1));
		intelligenceSkills.appendChild(CyberpunkSkill.ZOOLOGY, new SpecializedSkill(attribute, CyberpunkSkill.ZOOLOGY,
	...
	private void initializeLanguageSkills(Attribute attribute) {
		knowLanguage = new TreeNode<CyberpunkSkill>(CyberpunkSkill.KNOWN_LANGUAGE, new BroadSkill(
				CyberpunkSkill.KNOWN_LANGUAGE,
				"The knowledge of a foreign tongue." + " At +2, you can \"get by\" with speaking the language." //
		...
		intelligenceSkills.appendChild(knowLanguage);
		...
		knowLanguage.appendChild(CyberpunkSkill.PERSIAN, new SpecializedSkill(attribute, CyberpunkSkill.PERSIAN,
		...
		knowLanguage.appendChild(CyberpunkSkill.GREEK, new SpecializedSkill(attribute, CyberpunkSkill.GREEK,
				...
				1));
		knowLanguage.appendChild(CyberpunkSkill.JAPANESE, new SpecializedSkill(attribute, CyberpunkSkill.JAPANESE,
				...
				1));
		knowLanguage.appendChild(CyberpunkSkill.KOREAN, new SpecializedSkill(attribute, CyberpunkSkill.KOREAN,
	...
	private void initializeNigerCongoLanguageFamily(Attribute attribute) {
		nigerCongoFamily = new TreeNode<CyberpunkSkill>(CyberpunkSkill.NIGER_CONGO, new BroadSkill(
				CyberpunkSkill.NIGER_CONGO,
		...
		knowLanguage.appendChild(nigerCongoFamily);
		nigerCongoFamily.appendChild(CyberpunkSkill.SHONA, new SpecializedSkill(attribute, CyberpunkSkill.SHONA,
				...
				1));
		nigerCongoFamily.appendChild(CyberpunkSkill.AKAN, new SpecializedSkill(attribute, CyberpunkSkill.AKAN,
				...
				1));
		nigerCongoFamily.appendChild(CyberpunkSkill.KONGO, new SpecializedSkill(attribute, CyberpunkSkill.KONGO,
				...
				1));
		nigerCongoFamily.appendChild(CyberpunkSkill.ZULU, new SpecializedSkill(attribute, CyberpunkSkill.ZULU,
				...
				1));
		nigerCongoFamily.appendChild(CyberpunkSkill.SWAHILI, new SpecializedSkill(attribute, CyberpunkSkill.SWAHILI,
	...
	private void initializeBalticLanguageFamily(Attribute attribute) {
		balticFamily = new TreeNode<CyberpunkSkill>(CyberpunkSkill.BALTIC, new BroadSkill(CyberpunkSkill.BALTIC,
		...
		knowLanguage.appendChild(balticFamily);
		balticFamily.appendChild(CyberpunkSkill.LATVIAN, new SpecializedSkill(attribute, CyberpunkSkill.LATVIAN,
				...
				1));
		balticFamily.appendChild(CyberpunkSkill.LITHUANIAN, new SpecializedSkill(attribute, CyberpunkSkill.LITHUANIAN,
	...
	private void initializeFinnicLanguageFamily(Attribute attribute) {
		finnicFamily = new TreeNode<CyberpunkSkill>(CyberpunkSkill.FINNIC, new BroadSkill(CyberpunkSkill.FINNIC,
		...
		knowLanguage.appendChild(finnicFamily);
		finnicFamily.appendChild(CyberpunkSkill.ESTONIAN, new SpecializedSkill(attribute, CyberpunkSkill.ESTONIAN,
				...
				1));
		finnicFamily.appendChild(CyberpunkSkill.FINNISH, new SpecializedSkill(attribute, CyberpunkSkill.FINNISH,
	...
	private void initializeCelticLanguageFamily(Attribute attribute) {
		celticFamily = new TreeNode<CyberpunkSkill>(CyberpunkSkill.CELTIC, new BroadSkill(CyberpunkSkill.CELTIC,
		...
		knowLanguage.appendChild(celticFamily);
		celticFamily.appendChild(CyberpunkSkill.GAELIC, new SpecializedSkill(attribute, CyberpunkSkill.GAELIC,
				...
				1));
		celticFamily.appendChild(CyberpunkSkill.WELSH, new SpecializedSkill(attribute, CyberpunkSkill.WELSH,
				...
				1));
		celticFamily.appendChild(CyberpunkSkill.BRETON, new SpecializedSkill(attribute, CyberpunkSkill.BRETON,
	...
	private void initializeGermanicLanguageFamily(Attribute attribute) {
		germanicFamily = new TreeNode<CyberpunkSkill>(CyberpunkSkill.GERMANIC, new BroadSkill(CyberpunkSkill.GERMANIC,
		...
		knowLanguage.appendChild(germanicFamily);
		germanicFamily.appendChild(CyberpunkSkill.DANISH, new SpecializedSkill(attribute, CyberpunkSkill.DANISH,
				...
				1));
		germanicFamily.appendChild(CyberpunkSkill.DUTCH, new SpecializedSkill(attribute, CyberpunkSkill.DUTCH,
				...
				1));
		germanicFamily.appendChild(CyberpunkSkill.ENGLISH, new SpecializedSkill(attribute, CyberpunkSkill.ENGLISH,
				...
				1));
		germanicFamily.appendChild(CyberpunkSkill.GERMAN, new SpecializedSkill(attribute, CyberpunkSkill.GERMAN,
				...
				1));
		germanicFamily.appendChild(CyberpunkSkill.NORWEGIAN, new SpecializedSkill(attribute, CyberpunkSkill.NORWEGIAN,
				...
				1));
		germanicFamily.appendChild(CyberpunkSkill.SWEDISH, new SpecializedSkill(attribute, CyberpunkSkill.SWEDISH,
				...
				1));
		germanicFamily.appendChild(CyberpunkSkill.YIDDISH, new SpecializedSkill(attribute, CyberpunkSkill.YIDDISH,
	...
	private void initializePacificIslanderLanguageFamily(Attribute attribute) {
		pacificIslandGroupFamily = new TreeNode<CyberpunkSkill>(CyberpunkSkill.PACIFIC_ISLAND_GROUP, new BroadSkill(
				CyberpunkSkill.PACIFIC_ISLAND_GROUP,
		...
		knowLanguage.appendChild(pacificIslandGroupFamily);
		pacificIslandGroupFamily.appendChild(CyberpunkSkill.CHUUKESE, new SpecializedSkill(attribute,
				CyberpunkSkill.CHUUKESE, "Chuukese a member of the Micronesian branch of the Austronesian languages." //
				...
				1));
		pacificIslandGroupFamily.appendChild(CyberpunkSkill.TAGALOG, new SpecializedSkill(attribute,
				CyberpunkSkill.TAGALOG,
				...
				1));
		pacificIslandGroupFamily.appendChild(CyberpunkSkill.SAMOAN, new SpecializedSkill(attribute,
				CyberpunkSkill.SAMOAN,
				...
				1));
		pacificIslandGroupFamily.appendChild(CyberpunkSkill.JAVANESE, new SpecializedSkill(attribute,
				...
				1));
		pacificIslandGroupFamily.appendChild(CyberpunkSkill.MALAY, new SpecializedSkill(attribute, CyberpunkSkill.MALAY,
				...
				1));
		pacificIslandGroupFamily.appendChild(CyberpunkSkill.SUNDANESE, new SpecializedSkill(attribute,
				CyberpunkSkill.SUNDANESE,
				...
				1));
		pacificIslandGroupFamily.appendChild(CyberpunkSkill.INDONESIAN, new SpecializedSkill(attribute,
				...
				1));
		pacificIslandGroupFamily.appendChild(CyberpunkSkill.HAWAIIAN, new SpecializedSkill(attribute,
				CyberpunkSkill.HAWAIIAN,
	...
	private void initializeRomanticLanguageFamily(Attribute attribute) {
		romanticFamily = new TreeNode<CyberpunkSkill>(CyberpunkSkill.ROMANTIC, new BroadSkill(CyberpunkSkill.ROMANTIC,
		...
		knowLanguage.appendChild(romanticFamily);
		romanticFamily.appendChild(CyberpunkSkill.FRENCH, new SpecializedSkill(attribute, CyberpunkSkill.FRENCH,
				...
				1));
		romanticFamily.appendChild(CyberpunkSkill.ITALIAN, new SpecializedSkill(attribute, CyberpunkSkill.ITALIAN,
				...
				1));
		romanticFamily.appendChild(CyberpunkSkill.SPANISH, new SpecializedSkill(attribute, CyberpunkSkill.SPANISH,
				...
				1));
		romanticFamily.appendChild(CyberpunkSkill.PORTUGUESE, new SpecializedSkill(attribute, CyberpunkSkill.PORTUGUESE,
				...
				1));
		romanticFamily.appendChild(CyberpunkSkill.LATIN, new SpecializedSkill(attribute, CyberpunkSkill.LATIN,
	...
	private void initializeSemeticLanguageFamily(Attribute attribute) {
		semeticFamily = new TreeNode<CyberpunkSkill>(CyberpunkSkill.SEMETIC, new BroadSkill(CyberpunkSkill.SEMETIC,
		...
		knowLanguage.appendChild(semeticFamily);
		semeticFamily.appendChild(CyberpunkSkill.ARABIC, new SpecializedSkill(attribute, CyberpunkSkill.ARABIC,
				...
				1));
		semeticFamily.appendChild(CyberpunkSkill.HEBREW, new SpecializedSkill(attribute, CyberpunkSkill.HEBREW,
	...
	private void initializeSouthEastAsianLanguageFamily(Attribute attribute) {
		sinoTibetanAndSouthEastAsianFamily = new TreeNode<CyberpunkSkill>(CyberpunkSkill.SINO_TIBETAN_AND_SE_ASIAN,
				new BroadSkill(CyberpunkSkill.SINO_TIBETAN_AND_SE_ASIAN,
		...
		knowLanguage.appendChild(sinoTibetanAndSouthEastAsianFamily);
		sinoTibetanAndSouthEastAsianFamily.appendChild(CyberpunkSkill.BURMESE, new SpecializedSkill(attribute,
				CyberpunkSkill.BURMESE,
				...
				1));
		sinoTibetanAndSouthEastAsianFamily.appendChild(CyberpunkSkill.CANTONESE, new SpecializedSkill(attribute,
				CyberpunkSkill.CANTONESE,
				...
				1));
		sinoTibetanAndSouthEastAsianFamily.appendChild(CyberpunkSkill.MANDARIN, new SpecializedSkill(attribute,
				...
				1));
		sinoTibetanAndSouthEastAsianFamily.appendChild(CyberpunkSkill.THAI,
				new SpecializedSkill(attribute, CyberpunkSkill.THAI,
						...
						1));
		sinoTibetanAndSouthEastAsianFamily.appendChild(CyberpunkSkill.TIBETAN, new SpecializedSkill(attribute,
				CyberpunkSkill.TIBETAN,
				...
				1));
		sinoTibetanAndSouthEastAsianFamily.appendChild(CyberpunkSkill.VIETNAMESE, new SpecializedSkill(attribute,
	...
	private void initializeSlavicLanguageFamily(Attribute attribute) {
		slavicFamily = new TreeNode<CyberpunkSkill>(CyberpunkSkill.SLAVIC, new BroadSkill(CyberpunkSkill.SLAVIC,
				"The Slavic languages (also called Slavonic languages) are the Indo-European languages spoken by the Slavic peoples." //
						...
						+ " which in turn is thought to have descended from the earlier Proto-Balto-Slavic language, linking the Slavic"//
						+ " languages to the Baltic languages in a Balto-Slavic group within the Indo-European family."));
		knowLanguage.appendChild(slavicFamily);
		slavicFamily.appendChild(CyberpunkSkill.BULGARIAN, new SpecializedSkill(attribute, CyberpunkSkill.BULGARIAN,
				...
				1));
		slavicFamily.appendChild(CyberpunkSkill.RUSSIAN, new SpecializedSkill(attribute, CyberpunkSkill.RUSSIAN,
				...
				1));
		slavicFamily.appendChild(CyberpunkSkill.CZECH, new SpecializedSkill(attribute, CyberpunkSkill.CZECH,
				...
				1));
		slavicFamily.appendChild(CyberpunkSkill.POLISH, new SpecializedSkill(attribute, CyberpunkSkill.POLISH,
				...
				1));
		slavicFamily.appendChild(CyberpunkSkill.UKRANIAN, new SpecializedSkill(attribute, CyberpunkSkill.UKRANIAN,
				"Ukrainian is an Eastern Slavonic language closely related to Belarusian, Polish, and Serbian." //
						...
						+ " including Argentina, Armenia, Azerbaijan, Belarus, Brazil, Canada, Estonia, Georgia, Hungary," //
						+ " Kazakhstan, Kyrgyzstan, Latvia, Lithuania, Moldova, Paraguay, Poland, Romania, Russia and Slovakia.",
				1));
		slavicFamily.appendChild(CyberpunkSkill.SLOVAK, new SpecializedSkill(attribute, CyberpunkSkill.SLOVAK,
	...
	private void initializeReflexSkills() {
		...
		reflexSkills = new TreeNode<CyberpunkSkill>(CyberpunkSkill.REFLEX_SKILLS, null);
		allSkills.appendChild(reflexSkills);
		reflexSkills.appendChild(CyberpunkSkill.ARCHERY,
				new SpecializedSkill(attribute, CyberpunkSkill.ARCHERY,
						"The skill required to use bows, crossbows and other arrow-based ranged weapons." //
								+ " See Handgun for details.",
						1));
		reflexSkills.appendChild(CyberpunkSkill.ATHLETICS,
				new SpecializedSkill(attribute, CyberpunkSkill.ATHLETICS,
						...
						1));
		reflexSkills.appendChild(CyberpunkSkill.BRAWLING, new SpecializedSkill(attribute, CyberpunkSkill.BRAWLING,
				...
				1));
		reflexSkills.appendChild(CyberpunkSkill.DANCE, new SpecializedSkill(attribute, CyberpunkSkill.DANCE,
				...
				1));
		reflexSkills.appendChild(CyberpunkSkill.DODGE_AND_ESCAPE, new SpecializedSkill(attribute,
				...
				1));
		reflexSkills.appendChild(CyberpunkSkill.DRIVING, new SpecializedSkill(attribute, CyberpunkSkill.DRIVING,
				...
				1));
		reflexSkills.appendChild(CyberpunkSkill.FENCING,
				new SpecializedSkill(attribute, CyberpunkSkill.FENCING, "The mastery of swords, rapiers and monoblades." //
						...
						1));
		reflexSkills.appendChild(CyberpunkSkill.HANDGUN, new SpecializedSkill(attribute, CyberpunkSkill.HANDGUN,
				...
				1));
		reflexSkills.appendChild(CyberpunkSkill.HEAVY_WEAPONS, new SpecializedSkill(attribute,
		...
		reflexSkills.appendChild(CyberpunkSkill.MELEE, new SpecializedSkill(attribute, CyberpunkSkill.MELEE,
				...
				1));
		reflexSkills.appendChild(CyberpunkSkill.MOTORCYCLE, new SpecializedSkill(attribute, CyberpunkSkill.MOTORCYCLE,
				"The required skill to operate motorcycles, cyberbikes and other two and three-wheeled vehicles.", 1));
		reflexSkills.appendChild(CyberpunkSkill.OPERATE_HEAVY_MACHINERY,
				new SpecializedSkill(attribute, CyberpunkSkill.OPERATE_HEAVY_MACHINERY,
		...
		reflexSkills.appendChild(CyberpunkSkill.RIFLE, new SpecializedSkill(attribute, CyberpunkSkill.RIFLE,
				"You must have this skill to use riffle/shotguns effectively (see Handgun limitations and modifiers).",
				1));
		reflexSkills.appendChild(CyberpunkSkill.STEALTH, new SpecializedSkill(attribute, CyberpunkSkill.STEALTH,
				...
				2));
		reflexSkills.appendChild(CyberpunkSkill.SUBMACHINEGUN, new SpecializedSkill(attribute,
	...
	private void initializeMartialArtSkills(Attribute attribute) {
		martialArt = new TreeNode<CyberpunkSkill>(CyberpunkSkill.MARTIAL_ART, new BroadSkill(CyberpunkSkill.MARTIAL_ART,
		...
		reflexSkills.appendChild(martialArt);
		martialArt.appendChild(CyberpunkSkill.AIKIDO, new SpecializedSkill(attribute, CyberpunkSkill.AIKIDO,
				...
				3));
		martialArt.appendChild(CyberpunkSkill.ANIMAL_KUNG_FU, new SpecializedSkill(attribute,
				...
				3));
		martialArt.appendChild(CyberpunkSkill.BOXING,
				new SpecializedSkill(attribute, CyberpunkSkill.BOXING,
						...
						1));
		martialArt.appendChild(CyberpunkSkill.CAPOERIA, new SpecializedSkill(attribute, CyberpunkSkill.CAPOERIA,
				...
				3));
		martialArt.appendChild(CyberpunkSkill.CHOI_LI_FUT, new SpecializedSkill(attribute, CyberpunkSkill.CHOI_LI_FUT,
				...
				3));
		martialArt.appendChild(CyberpunkSkill.JUDO, new SpecializedSkill(attribute, CyberpunkSkill.JUDO,
				...
				1));
		martialArt.appendChild(CyberpunkSkill.KARATE,
				new SpecializedSkill(attribute, CyberpunkSkill.KARATE,
						...
						2));
		martialArt
				.appendChild(CyberpunkSkill.TAE_KWON_DO,
						new SpecializedSkill(attribute, CyberpunkSkill.TAE_KWON_DO,
								...
								3));
		martialArt.appendChild(CyberpunkSkill.THAI_KICK_BOXING, new SpecializedSkill(attribute,
				...
				4));
		martialArt.appendChild(CyberpunkSkill.WRESTLING, new SpecializedSkill(attribute, CyberpunkSkill.WRESTLING,
	...
	private void initializePilotingSkills(Attribute attribute) {
		piloting = new TreeNode<CyberpunkSkill>(CyberpunkSkill.PILOTING,
				new BroadSkill(CyberpunkSkill.PILOTING, "In general, this is the skill of controlling aircraft." //
		...
		reflexSkills.appendChild(piloting);
		piloting.appendChild(CyberpunkSkill.PILOT_GYRO, new SpecializedSkill(attribute, CyberpunkSkill.PILOT_GYRO,
				"The ability to pilot all types of rotorwing aircraft, including gyros, copters and Osperys.", 3));
		piloting.appendChild(CyberpunkSkill.PILOT_FIXED_WING, new SpecializedSkill(attribute,
				...
				2));
		piloting.appendChild(CyberpunkSkill.PILOT_DIRIGIBLE, new SpecializedSkill(attribute,
				...
				2));
		piloting.appendChild(CyberpunkSkill.PILOT_VECTORED_THRUST_VEHICLE, new SpecializedSkill(attribute,
	...
	private void initializeTechnicalSkills() {
		...
		technicalSkills = new TreeNode<CyberpunkSkill>(CyberpunkSkill.TECHNICAL_ABILITY_SKILLS, null);
		allSkills.appendChild(technicalSkills);
		technicalSkills.appendChild(CyberpunkSkill.AERO_TECH, new SpecializedSkill(attribute, CyberpunkSkill.AERO_TECH,
				...
				2));
		technicalSkills.appendChild(CyberpunkSkill.AV_TECH,
				new SpecializedSkill(attribute, CyberpunkSkill.AV_TECH,
						...
						3));
		technicalSkills.appendChild(CyberpunkSkill.BASIC_TECH, new SpecializedSkill(attribute,
				...
				2));
		technicalSkills.appendChild(CyberpunkSkill.CRYOTANK_OPERATION, new SpecializedSkill(attribute,
				...
				1));
		technicalSkills.appendChild(CyberpunkSkill.CYBERDECK_DESIGN, new SpecializedSkill(attribute,
				CyberpunkSkill.CYBERDECK_DESIGN, "The required skill for designing cyberdecks." //
				...
				2));
		technicalSkills.appendChild(CyberpunkSkill.CYBERTECH, new SpecializedSkill(attribute, CyberpunkSkill.CYBERTECH,
				...
				2));
		technicalSkills.appendChild(CyberpunkSkill.DEMOLITIONS, new SpecializedSkill(attribute,
				...
				2));
		technicalSkills.appendChild(CyberpunkSkill.DISGUISE, new SpecializedSkill(attribute, CyberpunkSkill.DISGUISE,
				...
				1));
		technicalSkills.appendChild(CyberpunkSkill.ELECTRONICS, new SpecializedSkill(attribute,
				...
				1));
		technicalSkills.appendChild(CyberpunkSkill.ELECTRONIC_SECURITY, new SpecializedSkill(attribute,
				...
				2));
		technicalSkills.appendChild(CyberpunkSkill.FIRST_AID, new SpecializedSkill(attribute, CyberpunkSkill.FIRST_AID,
				...
				1));
		technicalSkills.appendChild(CyberpunkSkill.FORGERY, new SpecializedSkill(attribute, CyberpunkSkill.FORGERY,
				...
				1));
		technicalSkills.appendChild(CyberpunkSkill.GYRO_TECH, new SpecializedSkill(attribute, CyberpunkSkill.GYRO_TECH,
				"The skill of repairing and maintaining rotorwing aircraft such as helicopters and gyrocopters.", 3));
		technicalSkills.appendChild(CyberpunkSkill.PAINT_OR_DRAW, new SpecializedSkill(attribute,
				CyberpunkSkill.PAINT_OR_DRAW, "The skill of producing professional drawings." //
				...
				1));
		technicalSkills.appendChild(CyberpunkSkill.PHOTO_AND_FILM, new SpecializedSkill(attribute,
				...
				1));
		technicalSkills.appendChild(CyberpunkSkill.PICK_LOCK, new SpecializedSkill(attribute, CyberpunkSkill.PICK_LOCK,
				...
				1));
		technicalSkills.appendChild(CyberpunkSkill.PICK_POCKET, new SpecializedSkill(attribute,
				...
				1));
		technicalSkills.appendChild(CyberpunkSkill.PLAY_INSTRUMENT, new SpecializedSkill(attribute,
				CyberpunkSkill.PLAY_INSTRUMENT, "The skill of knowing how to play a musical instrument." //
				...
				1));
		technicalSkills.appendChild(CyberpunkSkill.WEAPONSMITH,
				new SpecializedSkill(attribute, CyberpunkSkill.WEAPONSMITH,
	...
	private void initializeDependantSkills() {
		/* Requires Mathematics >= 4 */
		CyberpunkSkill mathematics = allSkills.getChild(CyberpunkSkill.MATHEMATICS).getData();
		intelligenceSkills.appendChild(CyberpunkSkill.PHYSICS,
		...
		technicalSkills.appendChild(CyberpunkSkill.PHARMACEUTICALS,
				new SpecializedSkill(technicalAbility, CyberpunkSkill.PHARMACEUTICALS,
