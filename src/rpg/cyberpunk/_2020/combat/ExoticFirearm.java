...
public class ExoticFirearm extends Firearm {
	...
	/**
	 * Constructs a Firearm that uses the given damage instead of the damage from
	 * its ammunition.
	 * 
	 ...
	 */
	public ExoticFirearm(String weaponName, String description, String weaponType, String skillName, int weaponAccuracy,
		...
		super(weaponName, description, weaponType, skillName, weaponAccuracy, concealability, availability,
				ammunitionContainer, rateOfFire, reliability, rangeModifier, cost, weight, attachmentPoints);
		this.damage = damage;
	}
