...
public class BoxingFightingStyleFactory implements FightingStyleFactory {
	...
	public CyberpunkWeapon createStrike() {
		return new MeleeWeapon("Boxing Strike", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_BOXING,
	...
	public CyberpunkWeapon createKick() {
		return new MeleeWeapon("Boxing Kick", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_BOXING,
	...
	public CyberpunkWeapon createBlock() {
		return new MeleeWeapon("Boxing Block", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_BOXING,
	...
	public CyberpunkWeapon createDodge() {
		return new MeleeWeapon("Boxing Dodge", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_BOXING,
	...
	public CyberpunkWeapon createDisarm() {
		return new MeleeWeapon("Boxing Disarm", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_BOXING,
	...
	public CyberpunkWeapon createThrow() {
		return new MeleeWeapon("Boxing Throw", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_BOXING,
	...
	public CyberpunkWeapon createHold() {
		return new MeleeWeapon("Boxing Hold", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_BOXING,
	...
	public CyberpunkWeapon createEscape() {
		return new MeleeWeapon("Boxing Escape", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_BOXING,
	...
	public CyberpunkWeapon createChoke() {
		return new MeleeWeapon("Boxing Choke", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_BOXING,
	...
	public CyberpunkWeapon createSweep() {
		return new MeleeWeapon("Boxing Sweep", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_BOXING,
	...
	public CyberpunkWeapon createGrapple() {
		return new MeleeWeapon("Boxing Grapple", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED,
				CyberpunkSkill.MARTIAL_ARTS_BOXING, 0, CONCEALABILITY, AVAILABILITY, GRAPPLE_DAMAGE, false, RELIABILITY,
