...
public class JudoFightingStyleFactory implements FightingStyleFactory {
	...
	public CyberpunkWeapon createStrike() {
		return new MeleeWeapon("Judo Strike", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_JUDO, 0,
	...
	public CyberpunkWeapon createKick() {
		return new MeleeWeapon("Judo Kick", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_JUDO, 0,
	...
	public CyberpunkWeapon createBlock() {
		return new MeleeWeapon("Judo Block", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_JUDO, 0,
	...
	public CyberpunkWeapon createDodge() {
		return new MeleeWeapon("Judo Dodge", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_JUDO, 1,
	...
	public CyberpunkWeapon createDisarm() {
		return new MeleeWeapon("Judo Disarm", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_JUDO, 0,
	...
	public CyberpunkWeapon createThrow() {
		return new MeleeWeapon("Judo Throw", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_JUDO, 3,
	...
	public CyberpunkWeapon createHold() {
		return new MeleeWeapon("Judo Hold", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_JUDO, 2,
	...
	public CyberpunkWeapon createEscape() {
		return new MeleeWeapon("Judo Escape", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_JUDO, 2,
	...
	public CyberpunkWeapon createChoke() {
		return new MeleeWeapon("Judo Choke", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_JUDO, 0,
	...
	public CyberpunkWeapon createSweep() {
		return new MeleeWeapon("Judo Sweep", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_JUDO, 2,
	...
	public CyberpunkWeapon createGrapple() {
		return new MeleeWeapon("Judo Grapple", DESCRIPTION, CyberpunkWeapon.WEAPON_TYPE_UNARMED, CyberpunkSkill.MARTIAL_ARTS_JUDO, 2,
