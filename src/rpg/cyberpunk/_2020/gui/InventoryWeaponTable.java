...
public class InventoryWeaponTable extends JTable {
	 ...
	 * @author Coul Greer
	 */
	public static class InventoryWeaponTableModel extends AbstractTableModel implements PropertyChangeListener {
		/**
		...
		/**
		 * The index of the column used to hold the current amount of ammunition held
		 * out of the maximum amount of ammunition for a weapon to hold.
		 */
