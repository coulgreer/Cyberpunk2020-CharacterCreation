...
public class SpecializedCyberpunkSkillTest {
	private static Attribute mockedAttribute;

	private SpecializedSkill skill;
	...
	@Before
	public void setUp() {
		skill = new SpecializedSkill(mockedAttribute, CyberpunkSkill.CRYOTANK_OPERATION, "Works on cryotank", 1);
	}
